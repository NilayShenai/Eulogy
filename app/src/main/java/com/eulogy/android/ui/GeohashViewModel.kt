...
import com.eulogy.android.nostr.GeohashMessageHandler
import com.eulogy.android.nostr.GeohashRepository
import com.eulogy.android.nostr.NostrDirectMessageHandler
import com.eulogy.android.nostr.NostrIdentityBridge
import com.eulogy.android.nostr.NostrProtocol
import com.eulogy.android.nostr.NostrRelayManager
import com.eulogy.android.nostr.NostrSubscriptionManager
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.eulogy.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.eulogy.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.eulogy.android.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.eulogy.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.eulogy.android.model.BitchatMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.eulogy.android.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.eulogy.android.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.eulogy.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
            repo.setConversationGeohash(convKey, gh)
            com.eulogy.android.nostr.GeohashConversationRegistry.set(convKey, gh)
        }
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.eulogy.android.model.BitchatMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.eulogy.android.geohash.ChannelID?) {
        ...
        when (channel) {
            ...
            is com.eulogy.android.geohash.ChannelID.Location -> {
                ...
                viewModelScope.launch {
                    ...
                    com.eulogy.android.nostr.GeohashAliasRegistry.put("nostr_${dmIdentity.publicKeyHex.take(16)}", dmIdentity.publicKeyHex)
                }
            }
            null -> {
