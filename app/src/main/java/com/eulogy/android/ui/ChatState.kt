...
class ChatState {
    ...
    private val _selectedLocationChannel = MutableLiveData<com.eulogy.android.geohash.ChannelID?>(com.eulogy.android.geohash.ChannelID.Mesh)
    val selectedLocationChannel: LiveData<com.eulogy.android.geohash.ChannelID?> = _selectedLocationChannel
    ...
    fun setSelectedLocationChannel(channel: com.eulogy.android.geohash.ChannelID?) {
