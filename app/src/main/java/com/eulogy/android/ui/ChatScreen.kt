...
import com.eulogy.android.ui.media.FullScreenImageViewer
...
fun ChatScreen(viewModel: ChatViewModel) {
    ...
    val displayMessages = when {
        ...
        currentChannel != null -> channelMessages[currentChannel] ?: emptyList()
            ...
            if (locationChannel is com.eulogy.android.geohash.ChannelID.Location) {
    ...
    val showMediaButtons = when {
        ...
        else -> selectedLocationChannel !is com.eulogy.android.geohash.ChannelID.Location
    }

    // Swipe state for detecting left swipe gestures
        ...
        modifier = Modifier
            ...
            .pointerInput(Unit) {
                detectDragGestures(
                    ...
                    onDragEnd = {
                        // Swipe left (negative) with enough distance to open sidebar (People/Network tab)
        ...
        Column(
            ...
            MessagesList(
                ...
                onNicknameClick = { fullSenderName ->
                    ...
                    val mentionText = if (selectedLocationChannel is com.eulogy.android.geohash.ChannelID.Location && hashSuffix.isNotEmpty()) {
    ...
    androidx.compose.runtime.LaunchedEffect(Unit) {
        com.eulogy.android.ui.events.FileShareDispatcher.setHandler { peer, channel, path ->
            ...
            Surface(
                ...
                IconButton(onClick = { forceScrollToBottom = !forceScrollToBottom }) {
                    Icon(
                        ...
                        contentDescription = stringResource(com.eulogy.android.R.string.cd_scroll_to_bottom),
...
private fun ChatFloatingHeader(
    ...
    val locationManager = remember { com.eulogy.android.geohash.LocationChannelManager.getInstance(context) }
...
private fun ChatDialogs(
    ...
    if (showDebugSheet) {
        com.eulogy.android.ui.debug.DebugSettingsSheet(
