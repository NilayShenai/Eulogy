...
import com.eulogy.android.features.voice.VoiceWaveformCache
import com.eulogy.android.features.voice.resampleWave
...
fun ScrollingWaveformRecorder(
    ...
    WaveformCanvas(modifier = modifier, samples = samples, fillProgress = 1f, baseColor = Color(0xFF444444), fillColor = Color(0xFFC9A7EB)) // Soft lavender
}
...
fun WaveformPreview(
    ...
    WaveformCanvas(
        ...
        baseColor = Color(0x22C9A7EB), // Subtle lavender base
        fillColor = when {
            sendProgress != null -> Color(0xFFA3C4F3) // Pastel blue while sending
            else -> Color(0xFFB5EAD7) // Calm mint during playback
        },
        onSeek = onSeek
    )
}
