...
import com.eulogy.android.mesh.BluetoothMeshDelegate
import com.eulogy.android.mesh.BluetoothMeshService
import com.eulogy.android.model.BitchatMessage
import com.eulogy.android.model.BitchatMessageType
import com.eulogy.android.protocol.BitchatPacket


import kotlinx.coroutines.launch
import com.eulogy.android.util.NotificationIntervalManager
...
class ChatViewModel(
    ...
    private val debugManager by lazy { try { com.eulogy.android.ui.debug.DebugSettingsManager.getInstance() } catch (e: Exception) { null } }
    ...
    val selectedLocationChannel: LiveData<com.eulogy.android.geohash.ChannelID?> = state.selectedLocationChannel
    ...
    init {
        ...
        viewModelScope.launch {
            com.eulogy.android.mesh.TransferProgressManager.events.collect { evt ->
    ...
    private fun loadAndInitialize() {
        ...
        viewModelScope.launch {
            com.eulogy.android.ui.debug.DebugSettingsManager.getInstance().debugMessages.collect { msgs ->
                if (com.eulogy.android.ui.debug.DebugSettingsManager.getInstance().verboseLoggingEnabled.value) {
                    ...
                    if (selectedLocation is com.eulogy.android.geohash.ChannelID.Mesh) {
        ...
        com.eulogy.android.favorites.FavoritesPersistenceService.initialize(getApplication())


        // Ensure NostrTransport knows our mesh peer ID for embedded packets
        try {
            val nostrTransport = com.eulogy.android.nostr.NostrTransport.getInstance(getApplication())
    ...
    private fun ensureGeohashDMSubscriptionIfNeeded(convKey: String) {
        try {
            ...
            val repo = repoField.get(geohashViewModel) as com.eulogy.android.nostr.GeohashRepository
            ...
            if (!gh.isNullOrEmpty()) {
                ...
                val subMgr = subMgrField.get(geohashViewModel) as com.eulogy.android.nostr.NostrSubscriptionManager
                val identity = com.eulogy.android.nostr.NostrIdentityBridge.deriveIdentity(gh, getApplication())
                val subId = "geo-dm-$gh"
                ...
                if (currentId != subId) {
                    ...
                    subMgr.subscribeGiftWraps(
                        ...
                        handler = { event ->
                            ...
                            val dmHandler = dmHandlerField.get(geohashViewModel) as com.eulogy.android.nostr.NostrDirectMessageHandler
    ...
    fun startPrivateChat(peerID: String) {
        ...
        if (success) {
            ...
            try {
                val seen = com.eulogy.android.services.SeenMessageStore.getInstance(getApplication())
    ...
    fun openLatestUnreadPrivateChat() {
        try {
            ...
            val openPeer: String = if (targetKey.startsWith("nostr_")) {
                ...
                val canonical = com.eulogy.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
                    ...
                    nostrPubHexForAlias = { alias -> com.eulogy.android.nostr.GeohashAliasRegistry.get(alias) },
                    findNoiseKeyForNostr = { key -> com.eulogy.android.favorites.FavoritesPersistenceService.shared.findNoiseKey(key) }
                )
                canonical ?: targetKey
            }
    ...
    fun sendMessage(content: String) {
        ...
        if (content.startsWith("/")) {
            ...
            commandProcessor.processCommand(content, meshService, meshService.myPeerID, { messageContent, mentions, channel ->
                if (selectedLocationForCommand is com.eulogy.android.geohash.ChannelID.Location) {
        ...
        if (selectedPeer != null) {
            ...
            selectedPeer = com.eulogy.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
            ...
            privateChatManager.sendPrivateMessage(
                ...
                val router = com.eulogy.android.services.MessageRouter.getInstance(getApplication(), meshService)
                router.sendPrivate(messageContent, peerID, recipientNicknameParam, messageId)
            }
        } else {
            // Check if we're in a location channel
            val selectedLocationChannel = state.selectedLocationChannel.value
            if (selectedLocationChannel is com.eulogy.android.geohash.ChannelID.Location) {
    ...
    fun toggleFavorite(peerID: String) {
        ...
        try {
            ...
            if (peerInfo?.noisePublicKey != null) {
                ...
                if (peerID.length == 64 && peerID.matches(Regex("^[0-9a-fA-F]+$"))) {
                    try {
                        ...
                        val rel = com.eulogy.android.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(noiseKey!!)
            ...
            if (noiseKey != null) {
                ...
                val identityManager = com.eulogy.android.identity.SecureIdentityStateManager(getApplication())
                ...
                com.eulogy.android.favorites.FavoritesPersistenceService.shared.updateFavoriteStatus(
                ...
                try {
                    val myNostr = com.eulogy.android.nostr.NostrIdentityBridge.getCurrentNostrIdentity(getApplication())
    ...
    private fun updateReactiveStates() {
        ...
        sessionStates.forEach { (peerID, newState) ->
            ...
            if (old != "established" && newState == "established") {
                com.eulogy.android.services.MessageRouter
    ...
    fun panicClearAllData() {
        ...
        try {
            ...
            try {
                val store = com.eulogy.android.geohash.GeohashBookmarksStore.getInstance(getApplication())
                store.clearAll()
            } catch (_: Exception) { }
        ...
        // Reset nickname
        val newNickname = "a${Random.nextInt(1000, 9999)}"
        state.setNickname(newNickname)
        dataManager.saveNickname(newNickname)
    ...
    private fun clearAllCryptographicData() {
        try {
            ...
            try {
                com.eulogy.android.favorites.FavoritesPersistenceService.shared.clearAllFavorites()
    ...
    fun selectLocationChannel(channel: com.eulogy.android.geohash.ChannelID) {
