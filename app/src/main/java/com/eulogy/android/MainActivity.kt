...
import com.eulogy.android.mesh.BluetoothMeshService
import com.eulogy.android.onboarding.BluetoothCheckScreen
import com.eulogy.android.onboarding.BluetoothStatus
import com.eulogy.android.onboarding.BluetoothStatusManager
import com.eulogy.android.onboarding.BatteryOptimizationManager
import com.eulogy.android.onboarding.BatteryOptimizationPreferenceManager
import com.eulogy.android.onboarding.BatteryOptimizationScreen
import com.eulogy.android.onboarding.BatteryOptimizationStatus
import com.eulogy.android.onboarding.InitializationErrorScreen
import com.eulogy.android.onboarding.InitializingScreen
import com.eulogy.android.onboarding.LocationCheckScreen
import com.eulogy.android.onboarding.LocationStatus
import com.eulogy.android.onboarding.LocationStatusManager
import com.eulogy.android.onboarding.OnboardingCoordinator
import com.eulogy.android.onboarding.OnboardingState
import com.eulogy.android.onboarding.PermissionExplanationScreen
import com.eulogy.android.onboarding.PermissionManager
import com.eulogy.android.ui.ChatScreen
import com.eulogy.android.ui.ChatViewModel
import com.eulogy.android.ui.OrientationAwareActivity
import com.eulogy.android.ui.theme.BitchatTheme
...
class MainActivity : OrientationAwareActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize network preference manager
        com.eulogy.android.mesh.NetworkPreferenceManager.initialize(this)
        
        // Set up listener to restart Bluetooth when network changes
        com.eulogy.android.mesh.NetworkPreferenceManager.onNetworkChanged = { newMode ->
            android.util.Log.i("MainActivity", "Network changed to $newMode - restarting Bluetooth mesh")
            // Restart the mesh service to apply new network UUID
    ...
    private fun initializeApp() {
        ...
        lifecycleScope.launch {
            try {
                ...
                com.eulogy.android.nostr.LocationNotesInitializer.initialize(this@MainActivity)
                ...
                // Update LocationChannelManager permission state after permissions are granted
                com.eulogy.android.geohash.LocationChannelManager.getInstance(this@MainActivity).updatePermissionState()
                Log.d("MainActivity", "Updated LocationChannelManager permission state")
    ...
    override fun onResume() {
        ...
        if (mainViewModel.onboardingState.value == OnboardingState.COMPLETE) {
            ...
            // Update LocationChannelManager permission state in case user granted permissions in Settings
            com.eulogy.android.geohash.LocationChannelManager.getInstance(this).updatePermissionState()

            // Check if permissions were just granted in Settings (for Bluetooth)
            // If mesh service is not active but permissions are now granted, restart it
            if (!meshService.isActive() && permissionManager.areAllPermissionsGranted()) {
                Log.d("MainActivity", "Permissions granted while app was in background, restarting mesh service")
                lifecycleScope.launch {
                    meshService.startServices()
                }
            }
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.eulogy.android.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        val shouldOpenGeohashChat = intent.getBooleanExtra(
            com.eulogy.android.ui.NotificationManager.EXTRA_OPEN_GEOHASH_CHAT,
            false
        )
        
        when {
            shouldOpenPrivateChat -> {
                val peerID = intent.getStringExtra(com.eulogy.android.ui.NotificationManager.EXTRA_PEER_ID)
                val senderNickname = intent.getStringExtra(com.eulogy.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                val geohash = intent.getStringExtra(com.eulogy.android.ui.NotificationManager.EXTRA_GEOHASH)
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.eulogy.android.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.eulogy.android.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.eulogy.android.geohash.GeohashChannelLevel.CITY
                        4 -> com.eulogy.android.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.eulogy.android.geohash.GeohashChannelLevel.REGION
                        else -> com.eulogy.android.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
                    val geohashChannel = com.eulogy.android.geohash.GeohashChannel(level, geohash)
                    val channelId = com.eulogy.android.geohash.ChannelID.Location(geohashChannel)
