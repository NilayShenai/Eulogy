...
class PermissionManager(private val context: Context) {
    ...
    companion object {
        ...
        private const val PREFS_NAME = "eulogy_permissions"
     ...
     * 
     * IMPORTANT: On Android 12+, location permissions MUST be granted
     * BEFORE requesting Bluetooth permissions for BLE scanning to work properly.
     */
    fun getRequiredPermissions(): List<String> {
        val permissions = mutableListOf<String>()

        // Location permissions (required for both BLE scanning AND geohash features)
        // These MUST come first on Android 12+ for BLE to work properly
