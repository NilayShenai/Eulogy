...
import com.eulogy.android.util.AppConstants
...
class BluetoothGattServerManager(
    ...
    fun start(): Boolean {
        ...
        try {
            if (!com.eulogy.android.ui.debug.DebugSettingsManager.getInstance().gattServerEnabled.value) {
    ...
    private fun setupGattServer() {
        ...
        val serverCallback = object : BluetoothGattServerCallback() {
            ...
            override fun onCharacteristicWriteRequest(
                ...
                val characteristicUUID = AppConstants.getCharacteristicUUID(context)
        ...
        // Get UUIDs for the selected network
        val characteristicUUID = AppConstants.getCharacteristicUUID(context)
        ...
        val serviceUUID = AppConstants.getServiceUUID(context)
        val service = BluetoothGattService(serviceUUID, BluetoothGattService.SERVICE_TYPE_PRIMARY)
        service.addCharacteristic(characteristic)
        
        gattServer?.addService(service)
        
        Log.i(TAG, "GATT server setup complete with service UUID: $serviceUUID")
    }
    ...
    private fun startAdvertising() {
        // Respect debug setting
        val enabled = try { com.eulogy.android.ui.debug.DebugSettingsManager.getInstance().gattServerEnabled.value } catch (_: Exception) { true }
        ...
        Log.d(TAG, "Starting BLE advertisement with service UUID: $serviceUUID")
