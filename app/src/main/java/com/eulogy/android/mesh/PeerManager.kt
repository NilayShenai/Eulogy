...
class PeerManager {
    ...
    private val stalePeerTimeoutMs: Long = com.eulogy.android.util.AppConstants.Mesh.STALE_PEER_TIMEOUT_MS
    ...
    private fun startPeriodicCleanup() {
        ...
        cleanupJob = managerScope.launch {
            while (isActive) {
                delay(com.eulogy.android.util.AppConstants.Mesh.PEER_CLEANUP_INTERVAL_MS)
                cleanupStalePeers()
            }
        }
    }
