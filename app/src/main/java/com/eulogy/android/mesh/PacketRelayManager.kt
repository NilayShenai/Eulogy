...
class PacketRelayManager(private val myPeerID: String) {
    ...
    private fun isRelayEnabled(): Boolean = try {
        com.eulogy.android.ui.debug.DebugSettingsManager.getInstance().packetRelayEnabled.value
    ...
    // Coroutines
    private var relayScope = CoroutineScope(Dispatchers.IO + SupervisorJob())
