...
import com.eulogy.android.crypto.EncryptionService
...
import com.eulogy.android.protocol.SpecialRecipients
import com.eulogy.android.model.RequestSyncPacket
import com.eulogy.android.sync.GossipSyncManager
...
class BluetoothMeshService(private val context: Context) {
    ...
    companion object {
        ...
        private val MAX_TTL: UByte = com.eulogy.android.util.AppConstants.MESSAGE_TTL_HOPS
    }
        ...
        gossipSyncManager = GossipSyncManager(
            ...
            configProvider = object : GossipSyncManager.ConfigProvider {
                override fun seenCapacity(): Int = try {
                    com.eulogy.android.ui.debug.DebugPreferenceManager.getSeenPacketCapacity(500)
                } catch (_: Exception) { 500 }

                override fun gcsMaxBytes(): Int = try {
                    com.eulogy.android.ui.debug.DebugPreferenceManager.getGcsMaxFilterBytes(400)
                } catch (_: Exception) { 400 }

                override fun gcsTargetFpr(): Double = try {
                    com.eulogy.android.ui.debug.DebugPreferenceManager.getGcsFprPercent(1.0) / 100.0
    ...
    private fun setupDelegates() {
        ...
        messageHandler.delegate = object : MessageHandlerDelegate {
            ...
            override fun updatePeerIDBinding(newPeerID: String, nickname: String,
                ...
                try {
                    com.eulogy.android.favorites.FavoritesPersistenceService.shared.findNostrPubkey(publicKey)?.let { npub ->
                        com.eulogy.android.favorites.FavoritesPersistenceService.shared.updateNostrPublicKeyForPeerID(newPeerID, npub)
                    }
                } catch (_: Exception) { }
        ...
        connectionManager.delegate = object : BluetoothConnectionManagerDelegate {
            ...
            override fun onDeviceConnected(device: android.bluetooth.BluetoothDevice) {
                ...
                try {
                    ...
                    com.eulogy.android.ui.debug.DebugSettingsManager.getInstance()
    ...
    private fun restartSubsystems() {
        peerManager.restart()
        fragmentManager.restart()
        securityManager.restart()
        storeForwardManager.restart()
     ...
     */
    fun sendFileBroadcast(file: com.eulogy.android.model.BitchatFilePacket) {
        try {
     ...
     */
    fun sendFilePrivate(recipientPeerID: String, file: com.eulogy.android.model.BitchatFilePacket) {
        try {
            ...
            serviceScope.launch {
                ...
                if (encryptionService.hasEstablishedSession(recipientPeerID)) {
                    try {
                        ...
                        val noisePayload = com.eulogy.android.model.NoisePayload(
                            type = com.eulogy.android.model.NoisePayloadType.FILE_TRANSFER,
                            data = filePayload
                        )
        ...
        serviceScope.launch {
            ...
            if (encryptionService.hasEstablishedSession(recipientPeerID)) {
                try {
                    ...
                    val privateMessage = com.eulogy.android.model.PrivateMessagePacket(
                    ...
                    val messagePayload = com.eulogy.android.model.NoisePayload(
                        type = com.eulogy.android.model.NoisePayloadType.PRIVATE_MESSAGE,
                        data = tlvData
                    )
    ...
    fun sendReadReceipt(messageID: String, recipientPeerID: String, readerNickname: String) {
        serviceScope.launch {
            ...
            val geo = runCatching { com.eulogy.android.services.MessageRouter.tryGetInstance() }.getOrNull()
            val isGeoAlias = try {
                val map = com.eulogy.android.nostr.GeohashAliasRegistry.snapshot()
                map.containsKey(recipientPeerID)
            } catch (_: Exception) { false }
            if (isGeoAlias && geo != null) {
                geo.sendReadReceipt(com.eulogy.android.model.ReadReceipt(messageID), recipientPeerID)
                return@launch
            }
            
            try {
                
                val readReceiptPayload = com.eulogy.android.model.NoisePayload(
                    type = com.eulogy.android.model.NoisePayloadType.READ_RECEIPT,
     ...
     */
    fun getSessionState(peerID: String): com.eulogy.android.noise.NoiseSession.NoiseSessionState {
