package com.eulogy.android.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.eulogy.android.model.BitchatFilePacket
    ): String {
     ...
     */
    fun messageTypeForMime(mime: String): com.eulogy.android.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.eulogy.android.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> com.eulogy.android.model.BitchatMessageType.Audio
            else -> com.eulogy.android.model.BitchatMessageType.File
        }
    }
}
