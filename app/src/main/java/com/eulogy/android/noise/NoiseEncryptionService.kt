package com.eulogy.android.noise

import android.content.Context
import android.util.Log
import com.eulogy.android.identity.SecureIdentityStateManager
import com.eulogy.android.mesh.PeerFingerprintManager
import com.eulogy.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.eulogy.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS 
        private const val REKEY_MESSAGE_LIMIT = com.eulogy.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION 
    }
     ...
     */
    fun signPacket(packet: com.eulogy.android.protocol.BitchatPacket): com.eulogy.android.protocol.BitchatPacket? {
     ...
     */
    fun verifyPacketSignature(packet: com.eulogy.android.protocol.BitchatPacket, publicKey: ByteArray): Boolean {
