...
-keep class com.eulogy.android.protocol.** { *; }
-keep class com.eulogy.android.crypto.** { *; }
-dontwarn org.bouncycastle.**
-keep class org.bouncycastle.** { *; }

# Keep SecureIdentityStateManager from being obfuscated to prevent reflection issues
-keep class com.eulogy.android.identity.SecureIdentityStateManager {
    private android.content.SharedPreferences prefs;
    *;
}

# Keep all classes that might use reflection
-keep class com.eulogy.android.favorites.** { *; }
-keep class com.eulogy.android.nostr.** { *; }
-keep class com.eulogy.android.identity.** { *; }
